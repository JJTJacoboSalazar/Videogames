...
const CreateForm = ({allGenres, allPlatforms}) => {
    ...
    return(
        <div >
            ...
            <div >
                ...
                <ul >
                    <li >Name: {errors.name? errors.name : "Información correcta."}</li>
                    <li >Image: {errors.image? errors.image : "Información correcta."}</li>
                    <li >Description: {errors.description? errors.description : "Información correcta."}</li>
                    <li >Released: {errors.released? errors.released : "Información correcta."}</li>
                    <li >Rating: {errors.rating? errors.rating : "Información correcta."}</li>
                    <li >Genres: {errors.genres? errors.genres : "Información correcta."}</li>
                    <li >Platforms: {errors.platforms? errors.platforms : "Información correcta."}</li>
                </ul>
            </div>
        </div>
    )
